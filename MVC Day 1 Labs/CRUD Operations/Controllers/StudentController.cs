...
namespace CRUD_Operations.Controllers
{
    public class StudentController : Controller
    {
        ...
        public string Insert (int id , string std , int age)
        {
            ...
            return $"<h1>{std} Entered with Success</h1>";
        }
        ...
        public string Update(int id, string std, int age)
        {
            ...
            return $"<h1>Failed to update {student} </h1>";
        }
        ...
        public string Delete(int id)
        {
            ...
            if (student != null)
            {
                ...
                return $"<h1>{student} Deleted Successfully</h1>";
            }
            return $"<h1>Failed to delete {student}</h1>";
        }
    }
}
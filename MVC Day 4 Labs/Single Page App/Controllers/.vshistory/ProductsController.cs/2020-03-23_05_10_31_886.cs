...
namespace Single_Page_App.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            return View(db.Products.OrderByDescending(p => p.ID).ToList());
        }
        ...
        {
            ViewBag.SupplierID = new SelectList(db.Products, "SupID", "Name");
            return PartialView();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,ProductName,Units,Price,SupplierID")] Product product)
        {

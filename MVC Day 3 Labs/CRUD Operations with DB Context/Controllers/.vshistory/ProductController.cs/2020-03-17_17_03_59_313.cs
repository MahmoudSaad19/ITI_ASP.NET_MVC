...
namespace CRUD_Operations_with_DB_Context.Controllers
{
    public class ProductController : Controller
    {
        ...
        //static ContextManager context = new ContextManager();
        //internal SelectList listItems = new SelectList(context.Suppliers);
        ...
        {
            return View(contextManager.Products.Include(p => p.Supplier).ToList());
        }
        ...
        public ActionResult Update(int? id)
        {
            ...
            if (product != null)
            {
                //listItems = new SelectList(contextManager.Suppliers, "SupID", "Name", product.SupplierID);
                //ViewBag.SupplierID = new SelectList(contextManager.Suppliers, "SupID", "Name", product.SupplierID);
                ViewBag.context = contextManager.Suppliers.ToList();
                return View(product);
            }
            return View("_error");
        }
